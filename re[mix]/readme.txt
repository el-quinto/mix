...
\f0\b\fs24 \cf0 Max 7 / Live 9.2 or later required. 
\b0 \
...
\
mlr is a monome application by Brian Crabtree. if you haven\'92t tried it, i\'92d highly recommend u start there. re:mix will make much more sense if you do.\
\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97 \

\b\fs28 \ul installation
\b0\fs24 \ulnone \
this can be done in a variety of ways, but the absolute easiest method, is to place the downloaded folder wherever you\'92d prefer on your hard drive, then drag it into Live\'92s browser, under PLACES.\
...
\b\fs28 \ul quickstart
\b0\fs24 \ulnone \
Load the re:mix device onto an empty midi track. Group 1-6.amxd's are the audio outputs for each group. load these on separate audio tracks to get audio for those groups (and led movement). then drag wav, aiff, or mp3 files from Live\'92s browser, Session or Arrange view to the re:mix interface to load them to the desired row. Files/whole folders of files can be also be loaded by dragging from Finder. that\'92s about it, mash buttons and have fun!\
\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\

\b\fs28 \ul live sampling\

\b0\fs24 \ulnone place the input.amxd on the track you want to record. you can load multiple instaces on different tracks, and each can be set to record to a different input buffer (1-8) in re:mix\
\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\
...
\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97 \
sends/macros- you can control the values of the first 4 sends and first 8 device parameters on each group\'92s track for each row. when u trigger a sample, the sends/macros will jump to whatever values you have set for that row in re:mix. (send / macros toggles must be on) there\'92s an \'92example macros' effect rack included to get you started, but the fx are purposefully cheesy to encourage you to experiment and make your own. (tip- try sidechaining in your racks!)\
\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97 \
click Info in the setup tab for keyboard shortcuts!\
\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97\'97 \
\

\b\fs28 \ul 128/256 top row controls:
\b0\fs24 \ulnone \
