The Group1-6 .amxd's are the audio outputs for each group. If u don't load them, you won't get audio for those groups (or led movement). if u change the color of your group output tracks, the colors on the interface for the corresponding groups change too.
