...
————————————————————
live sampling- place the input.amxd on the track you want to record. you can load multiple instaces on different tracks, and each can be set to record to a different input buffer (1-8) in re:mix
————————————————————
